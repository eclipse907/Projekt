...
class Optimizator:
    ...
    def __init__(self, model, params, algorithm):
        ...
        self.second_moment_vector_1 = 0
        self.second_moment_vector_2 = 0
    ...
    def __sgdm(self, grad_W1, grad_W2):
        self.domain_point_derivative_1 = \
            self.params.momentum * self.domain_point_derivative_1 - self.params.learning_rate_sgdm * grad_W1
        self.domain_point_derivative_2 = \
            self.params.momentum * self.domain_point_derivative_2 - self.params.learning_rate_sgdm * grad_W2
    ...
    def __adam(self, grad_W1, grad_W2):
        self.first_moment_vector_1 = \
            self.params.beta_1 * self.first_moment_vector_1 + (1 - self.params.beta_1) * grad_W1
        self.first_moment_vector_2 = \
            self.params.beta_1 * self.first_moment_vector_2 + (1 - self.params.beta_1) * grad_W2
        self.second_moment_vector_1 = \
            self.params.beta_2 * self.second_moment_vector_1 + (1 - self.params.beta_2) * np.power(grad_W1, 2)
        self.second_moment_vector_2 = \
            self.params.beta_2 * self.second_moment_vector_2 + (1 - self.params.beta_2) * np.power(grad_W2, 2)
        computational_first_moment_vector_1 = \
            self.first_moment_vector_1 / (1 - np.power(self.params.beta_1, self.iterations + 1))
        computational_first_moment_vector_2 = \
            self.first_moment_vector_2 / (1 - np.power(self.params.beta_1, self.iterations + 1))
        computational_second_moment_vector_1 = \
            self.second_moment_vector_1 / (1 - np.power(self.params.beta_2, self.iterations + 1))
